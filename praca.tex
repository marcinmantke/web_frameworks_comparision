...
\begin{itemize}
  ...
  \item wsparcie dla js'ów
  \item wsparcie dla różnych silników szablonów
...
\subsection{Dostępność najczęściej wykorzystywanych mechanizmów}
\subsection{Subiektywna opinia}

\section{Phoenix vs Express}
\subsection{Filozofia działania}
\subsection{Architektura aplikacji, elementy składowe}
\subsection{Wygoda użytkowania} % ew zmiana nazwy
\subsection{Dostępność najczęściej wykorzystywanych mechanizmów}
\subsection{Subiektywna opinia} % podsumowanie
